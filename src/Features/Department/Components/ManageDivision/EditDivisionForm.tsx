...
import { divisionUpdateZodSchema } from "@/Features/Department/validations/manage-department.validation";
...
const EditDivisionForm = () => {
  const { divisions, divisionEditId } = useAppSelector(selectDivisionData);
